...
import com.laboontech.scordemy.activities.ebooks.adapters.EbookYearAdapter;
...
import com.laboontech.scordemy.databinding.ActivityEbookYearsBinding;
...
public class EbookYearsActivity extends AppCompatActivity {
    private static final String TAG = "EbookYearsActivity";
    private Activity activity;
    private ActivityEbookYearsBinding binding;
    private RetrofitApi mService;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityEbookYearsBinding.inflate(getLayoutInflater());
        ...
        if (bundle != null) {
            ...
            mService.getEbookYears(bundle.getString("prefix") + bundle.getString("id"))
                            ...
                            if (response.body() != null) {
                                if (response.body().code.equals(Constants.SUCCESS)) {
                                    ...
                                    if (response.body().res.size() > 0) {
                                        binding.recyclerview.setAdapter(new EbookYearAdapter(response.body().res));
                                    } else {
