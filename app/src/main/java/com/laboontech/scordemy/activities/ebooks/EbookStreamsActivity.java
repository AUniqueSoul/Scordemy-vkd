...
import com.laboontech.scordemy.activities.ebooks.adapters.EbookStreamAdapter;
...
import com.laboontech.scordemy.databinding.ActivityEbookStreamsBinding;
...
public class EbookStreamsActivity extends AppCompatActivity {
    private static final String TAG = "EbookStreamsActivity";
    private Activity activity;
    private ActivityEbookStreamsBinding binding;
    private RetrofitApi mService;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityEbookStreamsBinding.inflate(getLayoutInflater());
        ...
        if (bundle != null) {
            ...
            mService.getEbookStreams(bundle.getString("prefix")+bundle.getString("id"))
                            ...
                            if (response.body() != null){
                                if (response.body().code.equals(Constants.SUCCESS)) {
                                    ...
                                    if (response.body().res.size()>0){
                                        binding.recyclerview.setAdapter(new EbookStreamAdapter(response.body().res));
                                    }else{
